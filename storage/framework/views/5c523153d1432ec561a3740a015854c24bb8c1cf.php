            ...
            <div class="col-lg-12">
                <div class="card text-white bg-success my-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">Tu formulario a sido enviado con éxito con el N° 123r, no olvides enviar este número a tu vendedor.</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\portalmecanico_copia\resources\views/quotationshippingvalid.blade.php ENDPATH**/ ?>