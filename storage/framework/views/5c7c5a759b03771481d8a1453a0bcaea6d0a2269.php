    ...
    <div id="app">
            ...
            <div class="container">
                <main class="form-signin" >
                    <form method="POST" action="<?php echo e(url('acceso/user-id', ['url' => $url])); ?>">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                        <h1 class="h3 mb-3 fw-normal">Bienvenido a Suprapp, <?php echo e(old('title', $name)); ?></h1>
...
<?php /**PATH C:\xampp\htdocs\portalmecanico_copia\resources\views/acceso.blade.php ENDPATH**/ ?>